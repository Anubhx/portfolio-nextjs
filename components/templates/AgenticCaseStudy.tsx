...
export default function AgenticCaseStudy({ project, children }: Props) {
  return (
    <main className="pb-32 fade-in">
      <article>
        ...
        <header className="container max-w-4xl mt-24 mb-16">
          ...
          {/* Stack badges — foregrounded for technical audience */}
          ...
          {/* Project brief */}
          <div className="mt-10 grid grid-cols-2 md:grid-cols-3 gap-8 border-t border-border pt-8">
            <div>
            ...
            <div>
              <p className="editorial-meta mb-1">Domain</p>
              <p className="font-sans text-sm text-foreground">{project.category}</p>
            </div>
          </div>

          {/* Actions — demo, GitHub, docs upfront */}
          <div className="mt-10">
